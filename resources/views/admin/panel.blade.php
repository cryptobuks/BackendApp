                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link count-indicator dropdown-toggle" id="messageDropdown" href="#"
                           data-toggle="dropdown" aria-expanded="false">
                            ...
                            <span id="pendientes1" class="count">{{$pendientes}}</span>
                        </a>
                    </li>
                                ...
                                <div class="card-body">
                                    <div class="clearfix">
                                        ...
                                        <div class="float-right">
                                            ...
                                            <div class="fluid-container">
                                                <h3 class="font-weight-medium text-right mb-0">{{$respondidos}}</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="text-muted mt-3 mb-0">
                                            ...
                                            @else
                                                ...
                                                @foreach($sents as $sent)
                                                    <tr>
                                                        ...
                                                        <td>{{$sent->nombre}}</td>
                                                        <td>{{$sent->asunto}}</td>
                                                        <td>{{$sent->contenido}}</td>
                                                        <td>{{$sent->remitente}}</td>
                                                        <td>
                                                            @if($sent->ciudad == null)
                                                                ---
                                                            @else
                                                        ...
                                                        <form class="ui form" method="GET"
                                                              action="{{ route('admin.response', $sent->id) }}">
                                                            <td>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="col-md-12">
                                                <i class="mdi mdi-file-document-box" style="color: #63f248"></i>
                                                <span id="pendientesT" class="count"
                                                      style="color: #0c85d0"></span>
                                            </div>
                                        </div>


                                        <h4 class="card-title" style="margin-left: -90px; padding-top: 4px;">Mensajes
                                            Resueltos </h4>
                                        <div class="col-md-2">
                                            <select class="form-control" id="mescombo">
                                                @foreach($mesesTable as $mesT)
                                                    <option value="{{trim($mesT->id)}}"
                                                            @if(trim($mesT->id) == "$mesNum")
                                                            selected
                                                        @endif>
                                                        {{$mesT->name}}
                                                    </option>
                                        ...
                                        <div class="col-md-3" id="divhidde" style="display: none">
                                            <button class="btn btn-success" id="show">Ver</button>
                                        </div>
