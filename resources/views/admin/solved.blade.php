                ...
                <div class="content-wrapper">
                    ...
                    <center>
                        <div class="alert alert-secondary" role="alert">
                            <h4><b>Asunto:</b> {{$sent->asunto}}</h4>
                        </div>
                    </center>


                    <h4>Pregunta:</h4>
                    <input type="text" class="form-control" value="{{$sent->contenido}}" readonly/>
                    <br>

                    <h4>Respuesta:</h4>
                    <input class="form-control" value="{{$received->contenido}}" readonly name="contenido"/>
                    <br>

                    <form style="padding: 0" action="{{route('admin.dashboard', \Illuminate\Support\Facades\Session::get('adminId'))}}">
